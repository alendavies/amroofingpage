...
import { A as AstroError, k as RenderUndefinedEntryError, a as createComponent, r as renderTemplate, u as unescapeHTML, U as UnknownContentCollectionError, l as renderUniqueStylesheet, n as renderScriptElement, o as createHeadAndContent, d as renderComponent, i as AstroUserError } from './astro/server_B0kk_S5A.mjs';
import 'kleur/colors';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_CNmxEhpD.mjs');
...
const __vite_import_meta_env__ = {"ASSETS_PREFIX": undefined, "BASE_URL": "/", "DEV": false, "MODE": "production", "PROD": true, "SITE": "https://AMRoofing.com", "SSR": true};
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_DLS3A-Ii.mjs').then(n => n._);
...
export { BuiltInDefaultLocale as B, DeprecatedLabelsPropProxy as D, stripTrailingSlash as a, getCollectionPathFromRoot as b, stripLeadingSlash as c, ensureTrailingSlash as d, ensureHtmlExtension as e, stripHtmlExtension as f, getCollection as g, pickLang as h, stripExtension as i, ensureLeadingSlash as j, stripLeadingAndTrailingSlashes as k, getCollectionPath as l, project as p, renderEntry as r, starlightConfig as s, useTranslations as u };
